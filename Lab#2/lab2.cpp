...
/*
	ѕо сторонам треугольника, найти центр описанной окружности
...
void main()
{
	...
	float a1 = 0, b1 = 0, c1 = 0, a2 = 0, b2 = 0, c2 = 0; //коэффициенты двух уравнений пр€мых
	...
	/*
		...
		//кооффициенты 2х пр€мых, перпендикул€рных сторонам и проход€щих через их середины
	...
	*/
	...
	//координаты центра = точка пересечени€ пр€мых
	/*
